export const exampleInput = `light red bags contain 1 bright white bag, 2 muted yellow bags.
...
export const exampleInput2 = `shiny gold bags contain 2 dark red bags.
...
export const input = `plaid beige bags contain 3 drab magenta bags.
